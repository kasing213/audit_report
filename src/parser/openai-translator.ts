...
export class OpenAITranslator {
  ...
  private buildSystemPrompt(): string {
    return [
      ...
      '9) Detect if the message is reporting an UPDATE to an existing customer.',
      '   Update indicators: "now", "changed to", "update:", "status changed", "became"',
      '   If update detected, include "is_update": true in output.',
      '   If new customer or unclear, set "is_update": false.',
      '',
