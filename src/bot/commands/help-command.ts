...
export class HelpCommand {
  ...
  private buildSalesHelpMessage(): string {
    return [
      ...
      '',
      '🔸 *ទិន្នន័យអតិថិជនដែលបានកត់ត្រា*',
      '',
      'បន្ទាប់ពីបញ្ចូល ទិន្នន័យនឹងបង្ហាញដូចនេះ៖',
      '',
      '```',
      'Customer List',
      'Follower: Srey Sros',
      ...
      '1) yuth',
      '   Page: SunTV',
      '   First contact: 2026-01-02',
      '   Current status: cant afford',
      '   Updates: 1 event',
      '',
      '2) Heng Chita',
      '   Phone: 093 724 678',
      ...
      '• *PAGE* - ប្រភព (Facebook, TikTok, Sun TV, ...)',
      ...
      '• អតិថិជននីមួយៗទទួលបាន ID ដោយស្វ័យប្រវត្តិ (1, 2, 3...)',
      '',
      '---',
